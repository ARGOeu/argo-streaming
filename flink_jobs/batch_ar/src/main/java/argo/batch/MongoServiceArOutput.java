...
public class MongoServiceArOutput implements OutputFormat<ServiceAR> {
	...
	// constructor
	public MongoServiceArOutput(String uri, String col, String method) {
	...
	// constructor
	public MongoServiceArOutput(String host, int port, String db, String col, MongoMethod method) {
		this.mongoHost = host;
		this.mongoPort = port;
		this.dbName = db;
		this.colName = col;
