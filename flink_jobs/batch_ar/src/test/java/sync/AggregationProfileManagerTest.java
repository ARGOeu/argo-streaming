...
public class AggregationProfileManagerTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		assertNotNull("Test file missing", AggregationProfileManagerTest.class.getResource("/ops/ap1.json"));
	}

	@Test
	public void test() throws URISyntaxException, IOException {
		// Prepare Resource File
		URL resJsonFile = AggregationProfileManagerTest.class.getResource("/ops/ap1.json");
