...
public class GroupGroupManagerTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		assertNotNull("Test file missing", GroupGroupManagerTest.class.getResource("/avro/poem_sync_v2.avro"));
	}

	@Test
	public void test() throws URISyntaxException, IOException {
		// Prepare Resource File
		URL resAvroFile = GroupGroupManagerTest.class.getResource("/avro/poem_sync_v2.avro");
