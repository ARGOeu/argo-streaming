...
public class OperationsManagerTest {
    ...
    public static void setUpClass() {
        assertNotNull("Test file missing", OperationsManagerTest.class.getResource("/profiles/operations.json"));
    }
...
//        fail("The test case is a prototype.");
    ...
    public void testLoadJson() throws Exception {
        ...
        File jsonFile = new File(OperationsManagerTest.class.getResource("/profiles/operations.json").getFile());
        OperationsManager instance = new OperationsManager();
