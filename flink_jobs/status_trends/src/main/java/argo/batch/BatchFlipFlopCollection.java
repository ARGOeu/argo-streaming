 ...
 * --date:the date for which the job runs and need to return results , e.g
 ...
 * connect to e.g msg.example.com Optional: -- clearMongo: option to clear the
 * mongo db before saving the new result or not, e.g true -- N : the number of
 * the result the job will provide, if the parameter exists , e.g 10
 *
 */
