...
public class DowntimeCacheTest {
	...
	public void test() throws IOException, URISyntaxException {
		...
		period[1]="2018-05-14T23:59:00Z";            
                ...
                assertArrayEquals(dc2.getDowntimePeriod("2018-05-14", "cluster51.knu.ac.kr", "Site-BDII").toArray(),timePeriod.toArray());// Insert new element 2018-05-17 that will remove 2018-05-14
