...
--mongo.uri mongodb://localhost:21017/argo_TENANTA --mongo.method upsert --pdata \
hdfs://hdfs_test_host:hdfs_test_port/user/hdfs_test_user/argo/tenants/TENANTA/mdata/2018-02-10 \
...
--weights hdfs://hdfs_test_host:hdfs_test_port/user/hdfs_test_user/argo/tenants/TENANTA/sync/Critical/weights_2018-02-11.avro \
--downtimes hdfs://hdfs_test_host:hdfs_test_port/user/hdfs_test_user/argo/tenants/TENANTA/sync/Critical/downtimes_2018-02-11.avro \
...
class TestClass(unittest.TestCase):
    ...
    def test_compose_command(self):
        ...
        test_hdfs_commands["--weights"] = hdfs_sync + \
            "/Critical/weights_2018-02-11.avro"
        test_hdfs_commands["--downtimes"] = hdfs_sync + \
            "/Critical/downtimes_2018-02-11.avro"
