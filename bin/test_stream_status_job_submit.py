...
class TestClass(unittest.TestCase):
    ...
    def test_compose_command(self):
        ...
        args = parser.parse_args(['--Tenant', 'TENANTA', '--Date', '2018-03-05T00:00:00Z', '--Report', 'Critical', '--Timeout', "500"])
