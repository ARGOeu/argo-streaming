...
def publish(message, endpoint, project, topic, key):
    url = "https://" + endpoint + "/v1/projects/" + \
        project+"/topics/" + topic + ":publish?key=" + key
...
def main(args):
    ...
    for i, row in enumerate(reader):
        ...
        publish(json_str, args.ams_endpoint, args.ams_project,
                args.ams_topic, args.ams_key)
...
if __name__ == "__main__":
    ...
    arg_parser = ArgumentParser(
        description="Read a consumer avro file and publish rows to AMS")
