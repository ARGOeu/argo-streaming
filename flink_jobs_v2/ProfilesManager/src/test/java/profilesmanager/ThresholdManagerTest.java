...
public class ThresholdManagerTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		assertNotNull("Test file missing", ThresholdManagerTest.class.getResource("/profiles/EGI-algorithm.json"));
		assertNotNull("Test file missing", ThresholdManagerTest.class.getResource("/profiles/EGI-rules.json"));
	}
	...
	public void test() throws IOException, URISyntaxException {
		...
		URL opsJsonFile = ThresholdManagerTest.class.getResource("/profiles/EGI-algorithm.json");
		...
		// Prepare Resource File
		URL thrJsonFile = ThresholdManagerTest.class.getResource("/profiles/EGI-rules.json");
