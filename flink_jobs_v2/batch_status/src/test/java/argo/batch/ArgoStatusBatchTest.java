...
public class ArgoStatusBatchTest {
    ...
    public void testMain() throws Exception {
        ...
        URL mdataURL = ArgoStatusBatchTest.class.getResource("/test/metricdata_exclude.avro");
        ...
        URL unionpdataURL = ArgoStatusBatchTest.class.getResource("/test/uniondata_exclude.avro");
...
//        //************** Test CalcPrevStatus
        ...
        URL calcPrevStatusURL = ArgoStatusBatchTest.class.getResource("/test/expCalcPrevStatus.json");
...
//
        ...
        Assert.assertTrue(expMetricTimelines.containsAll(statusMetricTimeline.collect()));
        ...
        Assert.assertTrue(expEndpTimelines.containsAll(statusEndpointTimeline.collect()));
        ...
        Assert.assertTrue(expServTimelines.containsAll(statusServiceTimeline.collect()));
        ...
        Assert.assertTrue(expFunctionTimelines.containsAll(statusEndGroupFunctionTimeline.collect()));
        ...
        Assert.assertTrue(expGroupTimelines.containsAll(statusGroupTimeline.collect()));
//        //* *************  Test Status results 
//
        if (calcStatus) {
            ...
            URL expMTagsURL = ArgoStatusBatchTest.class.getResource("/test/expmtagsdata.json");
            ...
            Assert.assertTrue(expectedMTagsRes.containsAll(stDetailDS.collect()));
...
// Create status service data set
            ...
            URL statusendpURL = ArgoStatusBatchTest.class.getResource("/test/statusendpoint.json");
            ...
            Assert.assertTrue(expStatusEndpRes.containsAll(stEndpointDS.collect()));
            ...
            DataSet<StatusMetric> stServiceDS = statusServiceTimeline.flatMap(new CalcStatusService(params)).withBroadcastSet(mpsDS, "mps")
                    ...
                    .withBroadcastSet(apsDS, "aps");
            URL statusserviceURL = ArgoStatusBatchTest.class.getResource("/test/statusservice.json");
            ...
            Assert.assertTrue(expStatusServRes.containsAll(stServiceDS.collect()));
            DataSet<StatusMetric> stEndGroupDS = statusGroupTimeline.flatMap(new CalcStatusEndGroup(params))
                    .withBroadcastSet(mpsDS, "mps").withBroadcastSet(egpDS, "egp").withBroadcastSet(ggpDS, "ggp")
                    .withBroadcastSet(opsDS, "ops").withBroadcastSet(apsDS, "aps");

            URL statusgroupURL = ArgoStatusBatchTest.class.getResource("/test/statusgroup.json");
            ...
            Assert.assertTrue(expStatusGroupRes.containsAll(stEndGroupDS.collect()));
        }
        ...
        if (calcFlipFlops || calcStatusTrends) {
            ...
            if (calcFlipFlops) {
                ...
                Assert.assertTrue(expMetricStatisticRes.containsAll(trends.collect()));
                ...
                Assert.assertTrue(expEndpStatisticRes.containsAll(trends.collect()));
                ...
                Assert.assertTrue(expServStatisticRes.containsAll(trends.collect()));
                ...
                Assert.assertTrue(expGroupStatisticRes.containsAll(trends.collect()));
            ...
            if (calcStatusTrends) {
                ...
                List<Tuple8< String, String, String, String, String, Integer, Integer, String>> result = metricStatusTrendsData.collect();

                Assert.assertTrue(expMetricTrendsRes.containsAll(metricStatusTrendsData.collect()));
                ...
                Assert.assertTrue(expEndpTrendsRes.containsAll(endpointStatusTrendsData.collect()));
                ...
                Assert.assertTrue(expServTrendsRes.containsAll(serviceStatusTrendsData.collect()));
                ...
                Assert.assertTrue(expGroupTrendsRes.containsAll(groupStatusTrendsData.collect()));
        ...
        if (calcAR) {
            ...
            Assert.assertTrue(expectedEndpAr.containsAll(endpointArDS.collect()));
            ...
            Assert.assertTrue(expectedServAr.containsAll(serviceArDS.collect()));
            ...
            Assert.assertTrue(expectedGroupAr.containsAll(endpointGroupArDS.collect()));
    ...
    private List<String> loadExpectedDataFromFile(String filename, ExecutionEnvironment env) throws Exception {
        URL fileURL = ArgoStatusBatchTest.class.getResource(filename);
...
//            }
    ...
    public static String loadResJSON(String resURL) {
        ...
        InputStream jsonInputStream = ArgoStatusBatchTest.class
